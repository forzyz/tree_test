...
export const Board: React.FC = () => {
  const { selectValue, categoryRef, fieldRef } = useContext(
    ScaleContext
  ) as ScaleContextType;

  const { onMouseUp, onMouseMove, onMouseDown } = useMouseMove(
    fieldRef,
    categoryRef
  );

  return (
    <div ref={fieldRef} className={style.field} onMouseMove={onMouseMove}>
      <div
        ref={categoryRef}
